...
import { Funnel, MoreVertical, Paperclip, PlusIcon, Search, ShoppingCart, FileText, Printer } from "lucide-react";
...
export function HoseOrders({ onOrderClick }: HoseOrdersProps) {
  ...
  const { assets, pagination, loading, fetchAssets } = useGetAssets(profile?.customerNumbers[3]);
      ...
      cell: () => (
        <div className="flex items-center gap-2">
          <span className="cursor-pointer">
            <Image width={16} height={20} src="/icons/profile/wifi.svg" alt="Wifi" />
          </span>
          <span className="cursor-pointer">
            <Paperclip />
          </span>
      ...
      <div className="flex items-baseline space-x-6">
        ...
        <div className="flex w-[200px] items-center gap-2">
          ...
          <Select onValueChange={updateWarehouseForAllItems}>
            <SelectTrigger className="w-[100%] border-[#C1C4C2] text-[#0F1912] font-medium bg-white w-[170px]">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex w-[70%] items-center">
              <Select onValueChange={handleColumnChange}>
                <SelectTrigger className="w-[40%] border-[#C1C4C2] text-[#5A615D] bg-white w-[170px]">
                  <PlusIcon size={16} /> <SelectValue placeholder="Legg til kolonne" />
                </SelectTrigger>
                <SelectContent>
                  {statuses.map((status) => (
                    <SelectItem
            ...
            <div className="flex w-[70%] items-center">
              <Select onValueChange={handleFilterChange}>
                <SelectTrigger className="w-[40%] border-[#C1C4C2] text-[#5A615D] bg-white w-[140px]">
