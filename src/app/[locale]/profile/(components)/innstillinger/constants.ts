...
export const INNSTILLINGER_CLASSES = {
	...
	sectionBorder: "mt-12 border-t border-b border-[#E5E7E6] py-7",
	heading: "mb-4 text-xl font-semibold text-[#0F1912]",
	label: "mb-1 block text-sm font-medium text-[#5A615D]",
	labelDark: "text-[#0F1912]",
	inputDisabled: "w-full rounded-md border border-[#C1C4C2] bg-[#F5F5F5] px-3 py-2 text-[#5A615D]",
 ...
 */
export function getRoleKeyFromProfile(role: string | undefined): ProfileRoleKey {
