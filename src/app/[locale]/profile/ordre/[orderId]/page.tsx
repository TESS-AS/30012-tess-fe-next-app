...
export default function OrderDetails({
	...
	return (
		<div className="mx-auto max-w-[1200px] p-6">
			{/* Breadcrumb */}
			<div className="mb-6 flex items-center gap-2 rounded bg-[#F8F9F8] p-4 text-sm">
				<Link
					href="/profile"
						...
						{orderDetails.items.map((item, index) => (
							<div
								...
								<div className="flex items-center gap-4">
									<div className="flex h-16 w-16 items-center justify-center rounded bg-[#F8F9F8]">
										<Image
											src={item.image}
											alt={item.name}
											width={48}
					...
					<div className="ml-auto max-w-xs space-y-2">
						<div className="flex justify-between text-sm">
							...
							<span className="text-[#0F1912]">
								{orderDetails.summary.originalPrice}
							</span>
						</div>
						<div className="flex justify-between text-sm">
