...
export const UserDimensionsInput: React.FC<Props> = ({ orderData, setOrderData, dimensionInputMode, setDimensionInputMode }) => {
  ...
  useEffect(() => {
    ...
    setUserDimensionOne(orderData.salesOrderHeader.customersOrderReference || "");
