...
export function RFQRequestDialog({
	...
	return (
		<Dialog
			...
			<DialogContent
				className={cn(
					"max-h-[85vh] max-w-2xl overflow-y-auto rounded-2xl p-0",
					className,
				)}>
				...
				<div className="space-y-4 px-6 pb-6">
					...
					<div className="space-y-1">
						...
						<Select
							...
							<SelectContent>
								<SelectItem value="m-trykktest">
									m/trykktest og sertifikat
								</SelectItem>
								<SelectItem value="u-trykktest">
									u/trykktest og sertifikat
								</SelectItem>
