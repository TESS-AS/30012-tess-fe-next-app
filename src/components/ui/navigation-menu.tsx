...
const navigationMenuTriggerStyle = cva(
	"group inline-flex h-9 w-max items-center justify-center px-4 py-2 text-sm font-medium " +
		"border-b-2 border-transparent hover:border-emerald-500 transition-all duration-300 ease-out " +
...
function NavigationMenuViewport({
	...
	return (
		<div
			className={cn(
				"absolute top-full left-0 isolate z-50 mt-[-1px] flex justify-center",
			)}>
